...
st.set_page_config(
    ...
    layout="wide",  # allows sidebar and full width
...
st.sidebar.markdown(
    """
    - Upload an image in JPG, JPEG, PNG format.
    - The app extracts objects using **DeepLabV3+**.
    - Download your extracted object as PNG.
    """
)
st.sidebar.markdown("---")
