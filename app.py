...
[data-testid="stSidebarCollapseControl"] button {
    ...
    pointer-events: all !important; /* clickable even without hover */
}
...
st.markdown("<h4>Example: Object Extraction</h4>", unsafe_allow_html=True)
